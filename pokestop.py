...
c = "curl 'https://www.pokemongomap.info/includes/uy22ewsd1.php' -H 'Cookie: PHPSESSID=3mcm776vrtlip9kv9556vl1fg7; mapfilters=1[##split##]1[##split##]1[##split##]0[##split##]0[##split##]1[##split##]0[##split##]0; announcement2=1; __atssc=reddit%3B1; announcementnews=1; announcementnews4=1; __atuvc=1%7C27%2C6%7C28%2C8%7C29%2C9%7C30; _ga=GA1.2.1811255488.1499521885; _gid=GA1.2.1712956306.1500725650; latlngzoom=16[##split##]24.9921844568014[##split##]121.50908957774196' -H 'Origin: https://www.pokemongomap.info' -H 'Accept-Encoding: gzip, deflate, br' -H 'Accept-Language: zh-TW,zh;q=0.8,en-US;q=0.6,en;q=0.4,zh-CN;q=0.2' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36' -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'Accept: */*' -H 'Referer: https://www.pokemongomap.info/' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' --data 'fromlat=24.98785709112986&tolat=24.99651167012831&fromlng=121.49918686205899&tolng=121.51899229342496&fpoke=1&fgym=1&farm=0&nests=0&raids=1' --compressed" 
